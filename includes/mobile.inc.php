...
/**
 * @file
 * The mobile interface for file upload.
 *
 * This file is used to show the upload form (including captcha)
 * content on user's mobile/browser.
 *
 * @category UI
 *  * @package SedaMicro
...
<br />
<div id = "loadingDiv"><img id = "myImage" src = "images/loading.gif" 
style="z-index:5;"></div>
<center>
<br/>
<div id="doit">
...
<form action="seda_up.php" id="fileForm" method="post" 
...
<?php echo $lang["title"];?>:
    ...
    <input type="hidden" name="hashKey" id ="hashKey" value="<?php
    echo $eq['answer'];?>"/><br />
...
fileForm.onsubmit = 
function(){document.getElementById("loadingDiv").style.display="block";};
</script>
</body>
</html>
